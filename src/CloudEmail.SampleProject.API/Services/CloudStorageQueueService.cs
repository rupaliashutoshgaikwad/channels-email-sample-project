...
{
    public class CloudStorageQueueService : ICloudStorageQueueService
    {
        ...
        public CloudStorageQueueService(IAmazonSQS sqsClient, ILogger<LogEmailQueueService> logger, CloudStorageSqsConfiguration cloudStorageSqsConfiguration)
        {
            this.sqsClient = sqsClient;
            this.logger = logger;
            targetQueueUrl = cloudStorageSqsConfiguration.TargetQueueUrl;
            bucketName = cloudStorageSqsConfiguration.S3BucketName;
        }
